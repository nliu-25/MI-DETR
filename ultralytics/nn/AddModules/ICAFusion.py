...
class TransformerFusionBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # Resize positional embeddings to match the current feature resolution.
    ...
    def _resize_pos_embed(self, pos_embed, new_h, new_w):
        """
        Resize positional embeddings to match the new feature-map resolution.
        """
        # Get the original positional-embedding resolution.
        N, L, C = pos_embed.shape
        H = W = int(L ** 0.5)
        
        # Reshape positional embeddings to a 2D layout.
        ...
        # Flatten back to the sequence layout.
